  ...
  <div className="absolute -top-2 -right-2 z-10">
    ...
    >
      ...
      <path
        fill="#c4a8f8"
        opacity="0.3"
        d="M 15 5.5 C 31 5 48 4.5 63 5 C 70 5 75.5 9 75.5 16 C 76 30 75.5 45 75.5 59 C 75.5 65.5 70.5 68.5 62.5 64 C 53 57.5 45 50.5 37.5 42.5 C 30 34.5 22 24 17.5 16 C 15 11.5 14 7.5 15 5.5 Z"
      >
        <animate
          attributeName="d"
          values="M 15 5.5 C 31 5 48 4.5 63 5 C 70 5 75.5 9 75.5 16 C 76 30 75.5 45 75.5 59 C 75.5 65.5 70.5 68.5 62.5 64 C 53 57.5 45 50.5 37.5 42.5 C 30 34.5 22 24 17.5 16 C 15 11.5 14 7.5 15 5.5 Z;M 11 5.5 C 29 4.5 48 4.5 63 5 C 70 5 75.5 9 75.5 16 C 76 32 75.5 43 75.5 55 C 75.5 62 69.5 66 61 60.5 C 50 53 40.5 47 32.5 39 C 25.5 32 17 21 13 12.5 C 11.5 9.5 10.5 6.5 11 5.5 Z;M 18 6 C 33 5.5 50 4.5 64 5 C 70.5 5 75.5 9 75.5 17 C 76 28 75.5 47 75.5 62 C 75.5 68.5 71 71.5 63.5 66.5 C 55.5 61 48 55.5 41.5 48.5 C 34 40.5 25 26.5 21 20 C 18.5 15 17 8 18 6 Z;M 15 5.5 C 31 5 48 4.5 63 5 C 70 5 75.5 9 75.5 16 C 76 30 75.5 45 75.5 59 C 75.5 65.5 70.5 68.5 62.5 64 C 53 57.5 45 50.5 37.5 42.5 C 30 34.5 22 24 17.5 16 C 15 11.5 14 7.5 15 5.5 Z"
          dur="10s"
          repeatCount="indefinite"
        />
      </path>
      {/* 本体: 上辺(y=8)と右辺(x=72)は直線で写真の縁に沿い、頭と両足先は丸いキャップ。斜辺が大きくうねる */}
      <path
        fill="#d8c2f5"
        opacity="0.9"
        d="M 18 8 C 32 8 48 8 62 8 C 67.5 8 72 11.5 72 17 C 72 30 72 44 72 57 C 72 62 68.5 64.5 63.5 61 C 55 55 47 48 40 40 C 33 32 25 23 21 16 C 19 12.5 17.5 9.5 18 8 Z"
      >
        <animate
          attributeName="d"
          values="M 18 8 C 32 8 48 8 62 8 C 67.5 8 72 11.5 72 17 C 72 30 72 44 72 57 C 72 62 68.5 64.5 63.5 61 C 55 55 47 48 40 40 C 33 32 25 23 21 16 C 19 12.5 17.5 9.5 18 8 Z;M 14 8 C 30 8 48 8 62 8 C 67.5 8 72 11.5 72 17 C 72 32 72 42 72 53 C 72 59 68 62.5 62.5 58.5 C 52 51 43 45 35 37 C 28 30 20 20 16 13 C 14.5 10.5 13.5 8.8 14 8 Z;M 21 8 C 34 8 50 8 63 8 C 68 8 72 11.5 72 18 C 72 28 72 46 72 60 C 72 65 69 68 64.5 64 C 57 58 50 53 44 46 C 37 38 28 25 24 19 C 22 14.5 20.5 9.5 21 8 Z;M 18 8 C 32 8 48 8 62 8 C 67.5 8 72 11.5 72 17 C 72 30 72 44 72 57 C 72 62 68.5 64.5 63.5 61 C 55 55 47 48 40 40 C 33 32 25 23 21 16 C 19 12.5 17.5 9.5 18 8 Z"
          dur="10s"
          repeatCount="indefinite"
        />
      </path>
