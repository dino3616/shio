...
export const Contact = () => (
  <section id="contact" className="group relative z-10 flex flex-col items-center px-8 pt-28 pb-16">
    {/* UFO は Hero のモチーフと同じく無重力で漂う */}
    <div className="ufo-drift">
      <Ufo />
    </div>
    {/* 虹のビーム: 常時は薄く呼吸し、ホバーで強く(虹は動きの瞬間だけ) */}
    <div
      className="beam-breathe pointer-events-none -mt-2 h-64 w-72 opacity-40 transition-opacity duration-700 group-hover:opacity-90"
      style={{
    ...
    />
    <Reveal className="-mt-44 flex flex-col items-center">
      <h2 className="font-name text-star text-4xl font-black tracking-wide md:text-5xl">CONTACT</h2>
      <p className="font-mincho text-star/70 mt-4 text-sm tracking-[0.25em]">交信を待っています</p>
      <a
