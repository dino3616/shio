...
export const Meta: FC<MetaProps> = ({ title, hostname }) => (
  <Head>
    ...
    <meta property="og:image" content={`https://${hostname}/ogp.svg`} key={MetaKey.IMAGE} />
    <meta property="twitter:image" content={`https://${hostname}/ogp.svg`} key={MetaKey.TWITTER_IMAGE} />
