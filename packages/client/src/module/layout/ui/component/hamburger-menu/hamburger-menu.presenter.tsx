...
export const HamburgerMenu: FC<HamburgerMenuProps> = ({ iconSize, modalController, ...props }) => (
  <Dialog.Root open={modalController?.open} onOpenChange={modalController?.setOpen} {...props}>
      ...
      <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        >
          <Dialog.Title className="mx-5 text-5xl font-bold">
            <Link href="/" onClick={modalController?.toClose}>
              shio.dev
            </Link>
          </Dialog.Title>
          <NavigationMenu.Root>
            <NavigationMenu.List className="flex flex-col items-center justify-center space-y-5 text-2xl font-semibold underline">
              <NavigationMenu.Item>
                <NavigationMenu.Link href="/product" onClick={modalController?.toClose}>
                  Product
                </NavigationMenu.Link>
              </NavigationMenu.Item>
              <NavigationMenu.Item>
                <NavigationMenu.Link href="/blog" onClick={modalController?.toClose}>
                  Blog
                </NavigationMenu.Link>
              </NavigationMenu.Item>
              <NavigationMenu.Item>
                <NavigationMenu.Link href="/about" onClick={modalController?.toClose}>
                  About
                </NavigationMenu.Link>
              </NavigationMenu.Item>
              <NavigationMenu.Item>
                <NavigationMenu.Link href="/skill" onClick={modalController?.toClose}>
                  Skill
                </NavigationMenu.Link>
              </NavigationMenu.Item>
            </NavigationMenu.List>
